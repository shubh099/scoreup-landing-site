...
const ValueConfirmation = () => {
  ...
  return <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold leading-tight mb-3">
            ...
            <span className="text-primary">Let's Get Your Credit Score to </span>
      ...
      <div className="sticky bottom-0 bg-background border-t border-border p-4 shadow-lg">
        <Button onClick={handleProceedToPayment} size="lg" className="w-full bg-accent hover:bg-accent/90 text-accent-foreground h-12 text-base font-bold rounded-lg shadow-card transition-all duration-300">
          Proceed to Payment
        </Button>
      </div>
    </div>;
